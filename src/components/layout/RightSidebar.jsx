...
export function RightSidebar({ isOpen, onClose }) {
  return (
    <>
      ...
      {/* Sidebar Menu */}
      <aside 
        className={`fixed top-0 right-0 h-full w-64 bg-brand-surface shadow-xl z-50 transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}
      >
